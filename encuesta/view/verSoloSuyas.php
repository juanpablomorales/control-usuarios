...
$filas = $modelo->getListaEncuestas("email='$emailSesion'");
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><?php echo $nombreSesion; if($sesion->isAdministrador()){echo "( Administrador )";}else{echo "( Usuario )";}?></a>
                </div>
                <!-- /.navbar-header -->
...
foreach ($filas as $indice => $objeto) {
    ?>
                        <tr>
                            ...
                            <td><a href="<?php echo"../../pregRes/view/verTodasPR.php?idencuesta="
                            . "". $objeto->getId(); ?>"><?php echo $objeto->getTitulo(); ?></a></td>
                            
                            <td><?php if($sesion->isAdministrador()||$sesion->getUsuario()->getEmail()==$objeto->getEmail()){echo "<a class='borrar' "
                                . "href='../procesa/phpBorrarEncuesta.php?idencuesta=".$objeto->getId()."'>Borrar</a>";}?></td>
                        </tr>
                        <?php
                    }
                    ?>   
